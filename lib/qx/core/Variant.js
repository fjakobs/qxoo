...
qx.Bootstrap.define("qx.core.Variant",
{
  statics :
  {
    ...
    __init : function()
    {
      var variants = qx.global.qxvariants;
      if (variants)
      {
        for (var key in variants)
        {
          ...
          this.__variants[key].value = variants[key];
        }

        qx.global.qxvariants = undefined;

        try {
          delete qx.global.qxvariants;
        } catch(ex) {};
...
exports.Variant = qx.core.Variant;