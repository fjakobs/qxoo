...
require('qx/data/SingleValueBinding');
require('qx/core/Variant');
require('qx/data/Array');
require('qx/test/data/singlevalue/TextFieldDummy');
/* ************************************************************************
...
qx.Class.define("qx.test.data.singlevalue.Deep",
{
  ...
  members :
  {
    ...
    TODO_testDeepTargetNull: function() {
      qx.data.SingleValueBinding.bind(this.__a, "name", this.__b2, "child.lab.value");
    ...
    TODO_testDeepTargetChange3Remove : function() 
    {
      // set up the target chain
      this.__a.setChild(this.__b1);
      this.__b1.setChild(this.__b2);
...
exports.Deep = qx.test.data.singlevalue.Deep;