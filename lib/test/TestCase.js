...
exports.testNewFunction = function() {
  var f = eval("function() {qx.Class.define('foo')}");
  f();
}

exports._testEval = function() {  
  var f = new Function("qx.Class.define('foo')");
  f();
}
